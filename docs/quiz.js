...
const northGermanCities = [
    "Bremen", "Hamburg", "Hannover", "Kiel", "Lübeck", "Rostock",
    "Schwerin", "Oldenburg", "Osnabrück", "Braunschweig", "Wolfsburg",
    "Flensburg", "Bremerhaven", "Neumünster", "Norderstedt", "Wismar",
    "Stralsund", "Greifswald", "Neubrandenburg", "Emden", "Lüneburg",
    "Celle", "Hildesheim", "Salzgitter", "Wilhelmshaven", "Delmenhorst",
    "Göttingen", "Aurich", "Stade", "Cuxhaven"
];
...
class CityQuiz {
    ...
    updateImage() {
        ...
        this.nextHintBtn.disabled = this.currentHintIndex === this.images.length - 1;
        
        // Visual feedback for disabled state
        this.prevHintBtn.style.opacity = this.currentHintIndex === 0 ? "0.3" : "1";
        this.prevHintBtn.style.cursor = this.currentHintIndex === 0 ? "default" : "pointer";
        
        this.nextHintBtn.style.opacity = this.currentHintIndex === this.images.length - 1 ? "0.3" : "1";
        this.nextHintBtn.style.cursor = this.currentHintIndex === this.images.length - 1 ? "default" : "pointer";
    }
    ...
    handleKeydown(e) {
        ...
        if (e.key === "ArrowDown") {
            ...
            e.preventDefault();
            if (this.currentFocus > -1 && items && items[this.currentFocus] && items[this.currentFocus].classList.contains('suggestion-active')) {
    ...
    checkGuess() {
        ...
        if (dist <= tolerance) {
            ...
            this.feedbackElement.textContent = "❌ Diese Stadt kenne ich nicht oder zu viele Tippfehler.";
            this.feedbackElement.className = "feedback error";
        }
    }
}
